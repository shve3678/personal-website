...
const posts = [
  {
    id: "n1",
    date: "Aug 2026",
    title: "Why bone knows the difference between a jog and a jump",
    excerpt:
      "Osteocytes don't just count cycles — they read the waveform. A reflection on how strain-rate, not magnitude, may be the true remodeling signal, and what that means for exercise prescriptions.",
    read: "6 min",
    tag: "Mechanobiology",
  },
  {
      ...
      <div className="max-w-[1200px] mx-auto py-10 md:py-16">
        <div className="mb-16 max-w-2xl">
          ...
          <p className="mt-6 text-muted-foreground leading-relaxed">
            Short essays on mechanobiology, movement, and the surprising places they overlap.
