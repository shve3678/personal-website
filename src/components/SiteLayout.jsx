...
export default function SiteLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      <header
        className={`sticky top-0 z-50 transition-all duration-300 border-b border-border bg-[#d9c9a8] ${
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-10 h-16 flex items-end justify-between">
          <Link to="/" className="font-['Audiowide'] text-xl tracking-tight pb-2.5">
